    ...
    <div>
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-6">
        ...
        <div className="flex items-center gap-3">
          ...
          {/* Export CSV */}
          <button
            onClick={() => exportToCSV(rounds, `fundingscout-explore-${new Date().toISOString().slice(0, 10)}.csv`)}
            disabled={rounds.length === 0}
            className="flex items-center gap-1.5 px-3 py-2.5 rounded-lg border border-slate-700 bg-slate-900 text-sm text-slate-300 hover:text-white hover:border-slate-600 transition-colors disabled:opacity-40 disabled:cursor-not-allowed"
